"""
This file configures the Sphinx documentation build, see
https://www.sphinx-doc.org/en/master/usage/configuration.html
for details.

This file is based on
https://github.com/mstreng/recip/blob/master/docs/source/conf.py
as well as the SageMath (documenation build) source code, in particular the
file SAGE_SRC/sage/docs/conf.py.
"""

# General information about the project.
project = u"Computing with adèles and idèles"
copyright = u"2021, Mathé Hertogh"
package_name = "adeles"
package_folder = "../.."
authors = u"Mathé Hertogh"

import sys
import os

from sage.env import SAGE_DOC_SRC, SAGE_DOC, SAGE_SRC, SAGE_ROOT, MATHJAX_DIR, THEBE_DIR
...
html_static_path = [os.path.join(SAGE_DOC_SRC, 'common', 'themes', 'sage', 'static'), THEBE_DIR]
