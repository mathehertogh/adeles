...
N = 48  # level of our modular function weber_f2
...
for x in OmodNstar.gens_values():
    ...
    print("Hence the action of {} on weber_f is given by".format(x))
    print_action_on_weber_f2(d, STs)
    print("And the action of {} on zeta_{} is given by".format(x, N))
    print("  zeta_{} ]--> zeta_{}^{}".format(N, N, d))


print("=============================================================")
print("We pick zeta_38*weber_f2(theta) as our candidate class invariant.")
print("=============================================================")
print()
print("=============================================================")
...
for ideal_class in Cl:
    ...
    B, A = factored_shimura_connecting_homomorphism(v, output_prec=N)
    ...
    conjugate = CC.zeta(N)^d * weber_f2(tau, prec)
    if d % 8 in [3, 5]:
        conjugate *= -1
...
try:
    ...
    raise ValueError("Precision of our numerical complex computations ({} bits) is too low!".format(CC.prec()))
