...
class ProfiniteGraph:
    ...
    def _create_window(self):
        ...
        self.canvas.bind("<Button-2>", self._save_snapshot) # middle mouse click
    ...
    def _save_snapshot(self, event):
        """
        Save the current canvas to the file "mijntestplaatje.png"
        """
        ...
        self.im = grab((x0, y0, x1, y1))
        self.im.save("mijntestplaatje.png")
